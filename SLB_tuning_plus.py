...
for l in range(num_tuning):
    file_path = "Results/SLB_res/setting_1/LinReBootG_res_plus" + str(l) + ".csv"
...
for l in range(num_tuning):
    file_path = "Results/SLB_res/setting_2/LinReBootG_res_plus" + str(l) + ".csv"
    pd.DataFrame({'regret_avg':regret_avg_list_LinReBootG[l], 'regret_std':regret_std_list_LinReBootG[l]}).to_csv(file_path, index=None)
...
for l in range(num_tuning):
    file_path = "Results/SLB_res/setting_3/LinReBootG_res_plus" + str(l) + ".csv"
    pd.DataFrame({'regret_avg':regret_avg_list_LinReBootG[l], 'regret_std':regret_std_list_LinReBootG[l]}).to_csv(file_path, index=None)